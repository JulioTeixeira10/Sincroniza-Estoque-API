...
textoxml = open("C:\\Users\\Usefr\\Desktop\\Integração[Bmais - FC ]\\Sincroniza-Estoque\\output.xml","r")
...
with open("C:\\Users\\Usefr\\Desktop\\Integração[Bmais - FC ]\\Sincroniza-Estoque\\Input1B+.txt") as t1:
    file1 = t1.readlines()
...
for key, value in dict1.items():
    ...
    estoque = ET.SubElement(record, "Field", {"Name": "Estoque", "Value": value})
    change_flag_prod_api = ET.SubElement(record, "Field", {"Name": "ChangeFlagProdAPI", "Value": "0"})

xml_doc = ET.tostring(root, encoding="utf-8")
with open("C:\\Users\\Usefr\\Desktop\\Integração[Bmais - FC ]\\Sincroniza-Estoque\\output.xml", "wb") as f:
    f.write(xml_doc)
